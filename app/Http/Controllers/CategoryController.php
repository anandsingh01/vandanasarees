...
//        print_r($request->all());die;
        ...
        $savecategory->parent_id = $request->section_id;
...
//                print_r($importData);die;
                try {
                    $imageUrl = $importData[5]; // Assuming the image URL is in the 4th column
                    ...
                    $categoryExists = Category::where('slug', $slug)->orWhere('category_name', $importData[1])->exists();
                    ...
                    $saveSection->category_type = 'category';
