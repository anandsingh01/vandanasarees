    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-md-8 cart">
                <div class="title">
                    <div class="row">
                        ...
                        <div class="col align-self-center text-right text-muted"><?php echo e($getAllCart->count()); ?> items</div>
                    </div>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $getAllCart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-top border-bottom">
                            <!-- Product Image -->
                            <td class="col-1">
                                <img class="img-fluid" src="<?php echo e(asset($cartItem->getProducts->photo)); ?>" alt="Product Image">
                            </td>

                            <!-- Product Details -->
                            <td class="col-3">
                                <div><?php echo e($cartItem->getProducts->title ?? 'Product Name'); ?></div>
                                <div>Unit Price : Rs. <?php echo e(number_format($cartItem->getProducts->product_actual_price,2) ?? 'NA'); ?></div>
                            </td>
                            ...
                            <td class="col-2">
                                <div class="quantity_input f2p_quantity">
                                    <form action="#">
                                        <span class="input_number_decrement" data-cartid="<?php echo e($cartItem->id); ?>">–</span>
                                        <input class="input_number qty2" type="text"
                                               id="quantityInput2<?php echo e($cartItem->getProducts->id); ?>"
                                               value="<?php echo e($cartItem->cartqty); ?>" data-cartid="<?php echo e($cartItem->id); ?>" max="3" min="1">
                                        <span class="input_number_increment" data-cartid="<?php echo e($cartItem->id); ?>">+</span>
                                    </form>
                                </div>
                            </td>
                            ...
                            <!-- Subtotal -->
                            <td class="col-1">
                                Rs. <span id="total_price<?php echo e($cartItem->id); ?>"><?php echo e($cartItem->subtotal); ?></span>
                            </td>

                            <!-- Remove Button -->
                            <td class="col-1">
                                <div class="close remove-item" data-cartid="<?php echo e($cartItem->id); ?>">&times;</div>
                            </td>
                        </tr>
                ...
                <div class="back-to-shop"><a href="<?php echo e(url('/shop')); ?>">&leftarrow;</a><span class="text-muted">Back to shop</span></div>
            </div>
            ...
            <div class="col-md-4 summary">
                ...
                <hr>
                <div class="row">
                    <div class="col" style="padding-left:0;">ITEMS <?php echo e($getAllCart->count()); ?></div>
                    <div class="col text-right">Rs. <span id="subtotalamount"><?php echo e(number_format($getAllCart->sum('subtotal'),2)); ?></span></div>
                </div>
                <div class="row">
                ...
                <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                    ...
                    <div class="col text-right">Rs. <span id="final_amount"><?php echo e(number_format($getAllCart->sum('subtotal'),2)); ?></span></div>
                </div>
                    ...
                    <?php if(Auth::check()): ?>
                        <a href="<?php echo e(url('checkout')); ?>" class="custom_btn btn py-2 bg_success dark-pink">Proceed to Checkout</a>
                    <?php else: ?>
                        <a href="<?php echo e(url('/guest-checkout')); ?>" class="custom_btn py-2 btn bg_success dark-pink">Proceed to Checkout</a>
                    <?php endif; ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            function deleteConfirmation2(cartId) {
                $.ajax({
                    type: 'get',
                    url: "<?php echo e(url('delete-from-cart/')); ?>/" + cartId,
                    dataType: 'JSON',
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\silkashi\resources\views/web/cart.blade.php ENDPATH**/ ?>