...
<?php $__env->startSection('body'); ?>
    ...
    <section class="checkout_section sec_ptb_140 clearfix">
        <div class="container">
            ...
            <form action="<?php echo e(url('checkout/submit')); ?>" method="post">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="billing_form1">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <?php if(Session::has('discounted_total')): ?>
                                            <div class="coupon_applied">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <h6 style="font-size: 13px;font-weight: 800;">Coupon Applied: <?php echo e(Session::get('applied_coupon')); ?></h6>
                                                    </div>

                                                    <div class="col-md-4">
                                                        <span>
                                                            <a href="<?php echo e(url('remove-coupon')); ?>"
                            ...
                            <div class="form_wrap">
                                <div class="checkout_table">
                                    <table class="table mb_50">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $getAllCart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getAllCarts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td style="width:15%;">
                                                    <img src="<?php echo e(asset($getAllCarts->getProducts->photo)); ?>"
                                                         style="width:3.5rem;" alt="image_not_found">
                                                </td>
                                                <td style="width: 60%;">
                                                    <p class="item_title"> <?php echo e($getAllCarts->getProducts->title ?? ''); ?></p>
                                                    <p>
                                                     ₹ <?php echo e(number_format($getAllCarts->per_piece_price,2)); ?> * <?php echo e($getAllCarts->cartqty); ?>


                                                    </p>
                                                </td>

                                                <td style="width: 40%;"><span class="total_price<?php echo e($getAllCarts->id); ?>"
                                                          id="total_price<?php echo e($getAllCarts->id); ?>">
                                                        ₹ <?php echo e(number_format($getAllCarts->subtotal,2)); ?></span></td>
                                            </tr>
                                            <input type="hidden" name="product_name[]"
                                                   value="<?php echo e($getAllCarts->getProducts->title); ?>"/>

                                            <input type="hidden" name="product_id[]"
                                                   value="<?php echo e($getAllCarts->getProducts->id); ?>"/>
                                            
                                            <input type="hidden" name="qty[]" value="<?php echo e($getAllCarts->cartqty); ?>"/>
                                            <input type="hidden" name="price[]" value="<?php echo e($getAllCarts->price); ?>"/>
                                            <input type="hidden" name="per_piece_price[]"
                                                   value="<?php echo e($getAllCarts->per_piece_price); ?>"/>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 100%;"><span class="total_price">₹ <?php echo e(number_format($getsubtotal,2)); ?></span></td>
                                        </tr>
                                        <tr>
                                            <td class="text-left">
                                            ...
                                            <td >
                                                <span class="total_price">
                                                    <?php if(Session::has('discounted_total')): ?>
                                                        ...
                                                        <strike class="text-danger">₹ <?php echo e(number_format($get_count->cartTotal,2) ?? '0'); ?></strike>

                                                        <p class="final_amount d-inline-flex">
                                                            <span class="finalamountspan" style="font-size:17px; margin-right: 10px;">
                                                                ₹ <?php echo e(Session::get('discounted_total').'.00' ?? '0'); ?>
                                ...
                                <input type="hidden" name="subtotal" value="<?php echo e($getsubtotal); ?>"/>
                                <input type="hidden" name="final_amount" id="final_amount_input"
                                       value="<?php echo e($getsubtotal); ?>"/>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\silkashi\resources\views/web/guestcheckout.blade.php ENDPATH**/ ?>