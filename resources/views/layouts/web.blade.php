...
<head>
    ...
    <link rel="shortcut icon" href="{{asset($getCommonSetting->favicon)}}" type="image/x-icon">
...
<header>
    ...
    <div class="header-container">
        <div class="logo">
            <a href="{{url('/')}}"><img src="{{asset($getCommonSetting->logo_header)}}" alt="Vandana Sarees"></a>
        </div>
        ...
        <div class="header-icons">
            ...
            <a class="nav-link" href="{{url('/checkout/cart')}}" style="position: relative;">
...
<style>
    .footer {
        background: url({{asset($get_footer_banner->banner)}});
        color: #fff;
        padding: 40px 0;
        font-size: 14px;
    }
    ...
    .footer {
        background: url({{asset($get_footer_banner->banner)}});/* Replace with your background image URL */
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <address>
                    {{$getCommonSetting->contact_address}}
                    <br>
                    <strong>Phone:</strong> <a href="tel:{{$getCommonSetting->contact_phone}}">{{$getCommonSetting->contact_phone}}</a><br>
                    <strong>Email:</strong> <a href="">{{$getCommonSetting->contact_email}}</a>
                </address>
            </div>
            <div class="col-md-3">
                <h5>Legals</h5>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                {{--                </form>--}}
                <p>&copy; {{$getCommonSetting->copyright}}.</p>
