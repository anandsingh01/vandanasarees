...
{{--            </table>--}}
            <div class="row">
                <div class="plans">
                    <div class="title">Choose a Address</div>
                    <div class="row">
                        @forelse($user_addresses as $user_address)
                            <div class="col-md-6">
                                <label class="plan basic-plan" for="address{{$user_address->id}}">
                                    <input type="radio" name="selected_address" id="address{{$user_address->id}}" class="address-radio"
                                           data-address="{{ json_encode($user_address) }}" />
                                    <div class="plan-content">
                                        <div class="plan-details">
                                            <span>{{ $user_address->first_name }} {{ $user_address->last_name ?? '' }}</span>
                                            <span>{{ $user_address->address_1 }} {{ $user_address->city ?? '' }}</span>
                                            <span>{{ $user_address->state }} {{ $user_address->pincode ?? '' }}</span>
                                            <span>{{ $user_address->phone }} {{ $user_address->email ?? '' }}</span>
                                        </div>
                                    </div>
                                </label>
                            </div>
                        @empty
                            <div class="col-md-4">No Address Found</div>
                        @endforelse
                    </div>
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            radioButtons.forEach(function (radioButton) {
                                radioButton.addEventListener('change', function () {
                                    ...
                                    document.querySelector('[name="first_name"]').value = selectedAddress.first_name || '';
                                    document.querySelector('[name="last_name"]').value = selectedAddress.last_name || '';
                                    document.querySelector('[name="address_1"]').value = selectedAddress.address_1 || '';
                                    document.querySelector('[name="city"]').value = selectedAddress.city || '';
                                    document.querySelector('[name="state"]').value = selectedAddress.state || '';
                                    document.querySelector('[name="pincode"]').value = selectedAddress.pincode || '';
                                    document.querySelector('[name="phone"]').value = selectedAddress.phone || '';
                                    document.querySelector('[name="email"]').value = selectedAddress.email || '';
                                });
                            });
                        });
                    </script>
                        ...
                        <div class="billing_form mb_50">
                            ...
                            <div class="form_wrap">
                                ...
                                <div class="form_item">
                                    ...
                                    <input type="text" class="form-control" name="address_1" placeholder="House number and street name">
                                </div>
                                <div class="form_item">
                                ...
                                <div class="form_item" id="mobile">
                                    ...
                                    <input type="tel"  class="form-control" name="phone"
                                           ...
                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '');"
                                           id="mobileInput">
                                    <span class="flag-icon flag-icon-in">+91</span>
                                </div>
                                <div class="form_item">
                                ...
                                <div class="checkbox_item mb_30">
                                    <label for="save_address_checkbox">
                                        <input id="save_address_checkbox" name="save_address"
                                               value="yes"
                                               type="checkbox"> Save Address
                                    </label>
                                </div>
                                ...
                                <div id="popup_address" style="display: none;">
                                    <div class="billing_form mb_50">
                                        ...
                                        <div class="form_wrap">
                                            ...
                                            <div class="form_item">
                                                <span class="input_title">Email Address<sup>*</sup></span>
                                                <input type="email" name="billing_email" value="{{Auth::user()->email}}">
                                            </div>
                                        </div>
                                ...
                                <script>
                                    document.getElementById('ship_address_checkbox').addEventListener('change', function () {
                                        var popupAddress = document.getElementById('popup_address');
                                        var billingFields = popupAddress.querySelectorAll('[name^="billing_"]');
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        @if(Session::has('discounted_total'))
                                            <div class="coupon_applied">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <h6>Coupon Applied: {{ Session::get('applied_coupon') }}</h6>
                                                    </div>
                                ...
                                <div class="checkout_table">
                                    <table class="table text-center mb_50">
                                        ...
                                        @forelse($getAllCart as $getAllCarts)
                                            <tr>
                                                <td>
                                                    <img src="{{asset($getAllCarts->getProducts->photo)}}" style="width:100px;" alt="image_not_found">
                                                </td>
                                                <td>
                                                    <h4 class="item_title"> {{$getAllCarts->getProducts->title ?? ''}}</h4>
                                                    <input type="hidden" name="product_color[]" value="{{$getColor->attribute_value ?? '0'}}"/>
                                                </td>
                                                <td>
                                                ...
                                                <td><span class="total_price{{$getAllCarts->id}}" id="total_price{{$getAllCarts->id}}">
                                                        Rs. {{$getAllCarts->subtotal}}</span></td>
                                            </tr>
                                            <input type="hidden" name="product_name[]" value="{{$getAllCarts->getProducts->title}}"/>
        ...
        <span class="total_price">
            @if(Session::has('discounted_total'))
                <p class="final_amount d-inline-flex">
                                        <span class="finalamountspan"
                                              style="font-size:19px; margin-right: 10px;">Rs. {{Session::get('discounted_total') ?? '0'}}</span>

                    <strike class="text-danger">Rs. {{$get_count->cartTotal ?? '0'}}</strike>
                </p>

            @else
                Rs. {{$get_count->cartTotal ?? '0'}}
            @endif
        </span>
                                            </td>
                                        </tr>
                                ...
                                <input type="hidden" name="final_amount" id="final_amount_input" value="{{$getsubtotal}}"/>
                                    ...
                                    <ul class="ul_li_block clearfix">
                                        <li>
                                            <div class="checkbox_item mb-0 pl-0">
                                                <label for="cash_delivery">
                                                    <input id="cash_delivery" name="payment_mode" value="cod" type="radio" > Cash On Delivery</label>
                                        ...
                                        <li>
                                            <div class="checkbox_item mb-0 pl-0">
                                                ...
                                                <label for="cash_delivery">
                                                    <input id="cash_delivery2" name="payment_mode" value="online" type="radio" checked> Pay Online </label>
                                            </div>
