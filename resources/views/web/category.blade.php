...
@section('css')
    <style>
        ...
        section.breadcrumb_section.furniture_breadcrumb.deco_wrap.d-flex.align-items-center.clearfix{
...
@section('body')
    ...
    <div class="maindiv">
        ...
        <!-- breadcrumb_section - start
           ================================================== -->
        <section class="breadcrumb_section furniture_breadcrumb deco_wrap d-flex align-items-center clearfix"
                 style="background: url({{asset($category->banner_image)}});">
            ...
            <div class="filter_sidebar">
                ...
                <div class="fs_widget fs_category_list">
                    ...
                    <ul class="ul_li_block clearfix">
                        ...
                        @empty <h5 class="text-center">You will get something awesome very soon. </h5>
                        @endforelse
                    </ul>
                </div>
        ...
        function lazyLoad() {
            $('.lazy-load-row').each(function () {
                if (isElementInViewport(this) && !$(this).hasClass('loaded')) {
                    $(this).find('.lazy-load-item').each(function (index) {
                        var delay = 100 * index; // Adjust the delay as needed
                        var element = this;

                        setTimeout(function () {
                            $(element).removeClass('hidden').addClass('fade-in');
                        }, delay);
                    });
