...
{{--                        <p class="collection-text">THE FINEST</p>--}}
    ...
    <div class="hero-section my-5">
        <div class="hero-content">
            ...
            <a href="{{$get_middle_banner->banner_link ?? ''}}" class="btn">{{$get_middle_banner->banner_text ?? ''}}</a>
        </div>
    </div>
            ...
            <div class="row">
                @foreach($instagram_posts as $post)
                    <div class="col-md-4 mb-4">
                        <iframe src="{{ $post['permalink'] }}embed" width="400" height="480" frameborder="0" scrolling="no" allowtransparency="true"></iframe>
