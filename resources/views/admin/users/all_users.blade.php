                                ...
                                @if(!empty($users))
                                    @foreach($users as $key =>  $user)
                                        <tr>
                                            ...
                                            <td>
                                                @forelse($user->get_address as $key => $user_address)
                                                   Address  {{$key+1}} :
                                                    {{$user_address->first_name}} {{$user_address->last_name}} ,
                                                    {{$user_address->address_1}},{{$user_address->address_2}} ,
                                                    {{$user_address->city}},{{$user_address->state}} ,
                                                    {{$user_address->pincode}},
                                                    Phone : {{$user_address->phone}} , <br>
...
{{--                                            <td class="" style="">--}}
{{--                                                <a href="{{url('admin/view-orders/'.$user->id)}}" class="btn btn-primary waves-effect waves-float btn-sm waves-green">--}}
