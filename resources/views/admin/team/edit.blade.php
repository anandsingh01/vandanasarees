...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-team')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <input type="number" class="form-control" name="sequence" value="{{$team->sequence}}" />
                                </div>
                                <div class="col-lg-12 col-md-12 mtb-10">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" value="{{$team->phone}}" name="phone" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <label>Email</label>
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" value="{{$team->email}}" name="email" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" value="{{$team->fb}}" name="fb" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <label>Instagram</label>
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" value="{{$team->insta}}" name="insta" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <label>Twitter</label>
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" value="{{$team->twitter}}" name="twitter" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <label>Linkedin</label>
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" value="{{$team->linkedin}}" name="linkedin" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <option value="{{$roles->name}}" {{$team->designation == $roles->name ? 'selected' : ''}}>{{$roles->name}}</option>
                                        <?php } ?>
                                    </select>
{{--                                    <input type="text" class="form-control" name="designation" value="{{$team->name}}"/>--}}
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        ...
                                        @if(!empty($team->photo))
                                            <img src="{{asset($team->photo)}}" style="width:100px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>about</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="about" required class='form-control p-textarea summernote'
                                                   placeholder='Write your hobby..'>{{$team->about}}</textarea><br />
