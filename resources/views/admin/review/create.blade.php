...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/save-reviews')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>Content</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="review" required class='form-control p-textarea summernote' placeholder='Write your hobby..'></textarea><br />
                                    </div>
                                </div>
