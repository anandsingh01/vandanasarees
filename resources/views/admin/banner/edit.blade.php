                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <input type="text" class="form-control" name="banner_subheading"
                                           value="{{$banner->banner_subheading}}"
                                ...
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <textarea class="form-control summernote" name="banner_description"><?php echo $banner->banner_description;?></textarea>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <select name="display_area" class="form-control ms">
                                        ...
                                        <option value="5" {{$banner->display_area == 5 ? 'selected' : ''}}>Shop</option>
                                        <option value="6" {{$banner->display_area == 6 ? 'selected' : ''}}>Brand Page</option>
                                        <option value="7" {{$banner->display_area == 7 ? 'selected' : ''}}>Blog Page</option>
                                        <option value="8" {{$banner->display_area == 8 ? 'selected' : ''}}>Mystic Section (Home page)</option>
                                    </select>
                                </div>
