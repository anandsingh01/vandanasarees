...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-faqs')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    <label class="control-label" for="password"> Project Name </label>

                                    <input type="text" class="form-control" name="heading" value="{{$project->heading}}"/>
                                </div>
...
{{--                                            <img src="{{asset($project->featured_image)}}" style="width:100px;">--}}
{{--                                        @endif--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-lg-12 col-md-12">--}}
{{--                                    <label>Metal Image</label>--}}
{{--                                    <div class="input-group masked-input mb-3">--}}
{{--                                        <input type="file" class="form-control" name="metal_image" placeholder="">--}}
{{--                                        @if(!empty($project->metal_image))--}}
{{--                                            <img src="{{asset($project->metal_image)}}" style="width:100px;">--}}
{{--                                        @endif--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>about</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="metal_content" required class='form-control p-textarea summernote'
                                                   placeholder='Write your hobby..'>{{$project->metal_content}}</textarea><br />
