                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li>
                                <a href="{{url('admin/add-faqs')}}" class="btn btn-success">
                            ...
                            <table class="table dataTable js-exportable">
                                ...
                                @if(!empty($projects))
                                    @foreach($projects as $projectss)
                                        <tr>
                                            <td>{{$projectss->heading}}</td>
                                            <td>
                                                @if($projectss->status == 1)
                                                    <span class="badge badge-info text-white" >Current status : Active</span><br>
                                                    <span class="badge badge-danger">
                                                <a href="javascript:void(0)" data-id="{{$projectss->id}}"
                                            ...
                                            <td class="" style="">
                                                <a href="{{url('admin/edit-faqs/'.$projectss->id)}}" class="btn btn-primary waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
                                                <a href="javascript:void(0);" onclick="deleteConfirmation({{$projectss->id}})" class="btn btn-primary waves-effect waves-float btn-sm waves-red"><i class="zmdi zmdi-delete"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
        ...
        $(function() {
            $('.status').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/change-status-faqs")}}',
