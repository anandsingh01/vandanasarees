        ...
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ucwords($_GET['type'])}}</li>
                </ul>
...
{{--                            <select name="section_id" class="form-control show-tick ms select2" id="section_id" data-placeholder="Select">--}}
...
{{--                        </div>--}}
                        <div class="form-group">
                            <label for="category_name"><b>{{ucwords($_GET['type'])}} Name</b></label>
...
@section('js')
    ...
    <script>
        $('#uploadForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ url('admin/upload_category_Content') }}", // Adjust the route
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
        ...
        $(function() {
            $('#tabledata tbody').on("change", ".change_home_status", function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{ url("admin/change_home_status") }}',
                    data: { 'status': status, 'id': id, 'table': table },
                    success: function(data){
                        swal("Status Changed!");
                        location.reload();
