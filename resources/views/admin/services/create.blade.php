...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/save-services')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            <div class="row">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <select class="form-control" name="service_category">
                                            ...
                                            @forelse($service as $services)
                                                <option value="{{$services->url_slug}}">{{$services->service_name}}</option>
                                            @empty
                                                No Category
                                            @endforelse
                                        </select>
                                ...
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <textarea class="form-control" name="service_summary" > </textarea>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>Content</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="service_description" required class='form-control p-textarea summernote' placeholder='Write your hobby..'></textarea><br />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 mtb-10">
                                            ...
                                            <textarea class="form-control" name="block_summary_1" > </textarea>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 mtb-10">
                                            ...
                                            <textarea class="form-control" name="block_summary_2" > </textarea>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 mtb-10">
                                            ...
                                            <textarea class="form-control" name="block_summary_3" > </textarea>
                                        </div>
