                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li>
                                <a href="{{url('admin/add-annual-reports')}}" class="btn btn-success">
                                    ...
                                    @foreach($report as $reports)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" data-id="{{$reports->id}}"
...
{{--                                            </td>--}}
                                            <td class="" style="">
                                                <a href="{{url('admin/edit-annual-reports/'.$reports->id)}}" class="btn btn-primary waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
                                                <a href="javascript:void(0);" onclick="deleteConfirmation({{$reports->id}})" class="btn btn-primary waves-effect waves-float btn-sm waves-red"><i class="zmdi zmdi-delete"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
        ...
        $(function() {
            $('.status').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/change-annual-reports-status")}}',
        ...
        $(function() {
            $('.show_on_home').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/update-annual-reports-Status")}}',
                    data: {'status': status, 'id': id,'table' : table},
                    success: function(data){
                        // location.reload();
                        swal("Status Changed!");
        ...
        function deleteConfirmation(id) {
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{url('admin/delete-annual-reports')}}/" + id,
