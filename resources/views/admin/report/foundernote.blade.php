...
@section('body')
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>{{$page_heading}}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="zmdi zmdi-home"></i> ESF </a></li>
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-founder-note')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    <label class="control-label" for="password"> Founder's Name </label>
                                    <input type="text" class="form-control" name="founder_content_heading" value="{{$founders_note->founder_content_heading}}"/>
                                </div>

                                <div class="col-lg-12 col-md-12">
                                    <label>Founder Image</label>
                                    <div class="input-group masked-input mb-3">
                                        <input type="file" class="form-control" name="founder_image" placeholder="">
                                        @if(!empty($founders_note->founder_image))
                                            <img src="{{asset($founders_note->founder_image)}}" style="width:100px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="founder_note" required
                                                   class='form-control p-textarea summernote'
                                                   placeholder='Write your hobby..'>{{$founders_note->founder_note}}</textarea><br />

                                    </div>

                                    <input type="hidden" name="id" value="{{$founders_note->id}}">
                                </div>
                            </div>
                        </div>
                    </div>
